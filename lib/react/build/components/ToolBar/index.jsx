...
const ToolBar = (props) => {
    ...
    const nextClassName = classnames(getClassName('toolbar', prefixCls), className);
    ...
    return (<div className={nextClassName} style={nextStyle}>
      {dynamicRender || (<>
          ...
          <BatchOperation options={batchOptions} selectedRowKeys={selectedRowKeys} selectedRows={selectedRows}/>
        </>)}
    </div>);
};
